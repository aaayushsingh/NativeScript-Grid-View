  ...
  export module recyclerview {
    export module util {
      export class AsyncListUtil<T> {
        public refresh(): void;
        public constructor(
          param0: javalangClass<T>,
          param1: number,
          param2: androidx.recyclerview.util.AsyncListUtil.DataCallback,
          param3: androidx.recyclerview.util.AsyncListUtil.ViewCallback
        );
      ...
      export module AsyncListUtil {
        export abstract class DataCallback {
          public recycleData(
            param0: native.Array<javalangObject>,
            param1: number
          ): void;
          public constructor();
          public fillData(
  ...
  export module recyclerview {
    export module util {
      export class MessageThreadUtil {
        public getMainThreadProxy(
          param0: androidx.recyclerview.util.ThreadUtil.MainThreadCallback
        ): androidx.recyclerview.util.ThreadUtil.MainThreadCallback;
        public getBackgroundProxy(
          param0: androidx.recyclerview.util.ThreadUtil.BackgroundCallback
        ): androidx.recyclerview.util.ThreadUtil.BackgroundCallback;
      }
  ...
  export module recyclerview {
    export module util {
      export class SortedList<T> {
        ...
        public constructor(
          param0: javalangClass<T>,
          param1: androidx.recyclerview.util.SortedList.Callback,
          param2: number
        );
      ...
      export module SortedList {
        export class BatchedCallback extends androidx.recyclerview.util
          .SortedList.Callback {
          public constructor();
          public areContentsTheSame(
            param0: javalangObject,
            param1: javalangObject
          ): boolean;
          public areItemsTheSame(
            param0: javalangObject,
            param1: javalangObject
          ): boolean;
          ...
          public constructor(
            param0: androidx.recyclerview.util.SortedList.Callback
          );
  ...
  export module recyclerview {
    export module util {
      export class ThreadUtil {
        /**
         * Constructs a new instance of the androidx.recyclerview.util.ThreadUtil interface with the provided implementation.
         */
      ...
      export module ThreadUtil {
        export class BackgroundCallback {
          /**
           * Constructs a new instance of the androidx.recyclerview.util.ThreadUtil$BackgroundCallback interface with the provided implementation.
           */
          public constructor(implementation: {
            ...
            recycleTile(param0: androidx.recyclerview.util.TileList.Tile): void;
          });
          public recycleTile(
            param0: androidx.recyclerview.util.TileList.Tile
          ): void;
        ...
        export class MainThreadCallback {
          /**
           * Constructs a new instance of the androidx.recyclerview.util.ThreadUtil$MainThreadCallback interface with the provided implementation.
           */
          public constructor(implementation: {
            updateItemCount(param0: number, param1: number): void;
            addTile(
              param0: number,
              param1: androidx.recyclerview.util.TileList.Tile
            ): void;
  ...
  export module recyclerview {
    export module util {
      export class TileList {
        ...
        public addOrReplace(
          param0: androidx.recyclerview.util.TileList.Tile
        ): androidx.recyclerview.util.TileList.Tile;
        public getAtIndex(
          param0: number
        ): androidx.recyclerview.util.TileList.Tile;
        public clear(): void;
      ...
      export module TileList {
        export class Tile {
          ...
          public constructor(
            param0: javalangClass<java.lang.Object>,
            param1: number
          );
        }
      }
  ...
  export module recyclerview {
    export module widget {
      export class AdapterHelper {
        public obtainUpdateOp(
          param0: number,
          param1: number,
          param2: number,
          param3: javalangObject
        ): androidx.recyclerview.widget.AdapterHelper.UpdateOp;
        public recycleUpdateOp(
          param0: androidx.recyclerview.widget.AdapterHelper.UpdateOp
        ): void;
      ...
      export module AdapterHelper {
        export class Callback {
          /**
           * Constructs a new instance of the androidx.recyclerview.widget.AdapterHelper$Callback interface with the provided implementation.
           */
          public constructor(implementation: {
            findViewHolder(
              param0: number
          ...
          public offsetPositionsForRemovingLaidOutOrNewView(
            param0: number,
            param1: number
          ): void;
          public onDispatchFirstPass(
            param0: androidx.recyclerview.widget.AdapterHelper.UpdateOp
          ): void;
          ...
          public markViewHoldersUpdated(
            param0: number,
            param1: number,
            param2: javalangObject
          ): void;
          public offsetPositionsForMove(param0: number, param1: number): void;
          public onDispatchSecondPass(
            param0: androidx.recyclerview.widget.AdapterHelper.UpdateOp
          ): void;
          public offsetPositionsForRemovingInvisible(
            param0: number,
            param1: number
          ): void;
        }
    ...
    export module v7 {
      export module widget {
        ...
        export module ChildHelper {
          ...
          export class Callback {
            /**
             * Constructs a new instance of the androidx.recyclerview.widget.ChildHelper$Callback interface with the provided implementation.
             */
            public constructor(implementation: {
...
declare module androidx {
  export module recyclerview {
    export module widget {
      export class DefaultItemAnimator extends androidx.recyclerview.widget
        .SimpleItemAnimator {
        public isRunning(
          param0: androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemAnimatorFinishedListener
        ): boolean;
        ...
        public canReuseUpdatedViewHolder(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
        ): boolean;
        ...
        public canReuseUpdatedViewHolder(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder,
          param1: javautilList<java.lang.Object>
        ): boolean;
        public animateMove(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder,
          param1: number,
...
declare module androidx {
  export module recyclerview {
    export module widget {
      export class GridLayoutManager extends androidx.recyclerview.widget
        .LinearLayoutManager {
        ...
        public onItemsChanged(
          param0: androidx.recyclerview.widget.RecyclerView
        ): void;
        public onItemsUpdated(
          param0: androidx.recyclerview.widget.RecyclerView,
          param1: number,
          param2: number
        ): void;
        ...
        public setSpanSizeLookup(
          param0: androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup
        ): void;
        public supportsPredictiveItemAnimations(): boolean;
        public checkLayoutParams(
          param0: androidx.recyclerview.widget.RecyclerView.LayoutParams
        ): boolean;
        public constructor(
        ...
        public scrollVerticallyBy(
          param0: number,
          param1: androidx.recyclerview.widget.RecyclerView.Recycler,
          param2: androidx.recyclerview.widget.RecyclerView.State
        ): number;
        public onInitializeAccessibilityNodeInfoForItem(
          param0: androidx.recyclerview.widget.RecyclerView.Recycler,
          param1: androidx.recyclerview.widget.RecyclerView.State,
          param2: android.view.View,
          param3: android.support.v4.view.accessibility.AccessibilityNodeInfoCompat
        ): void;
        ...
        public constructor();
        public getRowCountForAccessibility(
          param0: androidx.recyclerview.widget.RecyclerView.Recycler,
          param1: androidx.recyclerview.widget.RecyclerView.State
        ): number;
        public prepareForDrop(
          param0: android.view.View,
        ...
        public onFocusSearchFailed(
          param0: android.view.View,
          param1: number,
          param2: androidx.recyclerview.widget.RecyclerView.Recycler,
          param3: androidx.recyclerview.widget.RecyclerView.State
        ): android.view.View;
        public constructor(
        ...
        public setMeasuredDimension(
          param0: android.graphics.Rect,
          param1: number,
          param2: number
        ): void;
        public onItemsRemoved(
          param0: androidx.recyclerview.widget.RecyclerView,
          param1: number,
          param2: number
        ): void;
        ...
        public getColumnCountForAccessibility(
          param0: androidx.recyclerview.widget.RecyclerView.Recycler,
          param1: androidx.recyclerview.widget.RecyclerView.State
        ): number;
        public onItemsUpdated(
      ...
      export module GridLayoutManager {
        export class DefaultSpanSizeLookup extends androidx.recyclerview.widget
          .GridLayoutManager.SpanSizeLookup {
          public getSpanIndex(param0: number, param1: number): number;
          public getSpanSize(param0: number): number;
          public constructor();
        }
        export class LayoutParams extends androidx.recyclerview.widget
  ...
  export module recyclerview {
    export module widget {
      export class LinearLayoutManager
        ...
        implements
          androidx.recyclerview.widget.helper.ItemTouchHelper.ViewDropHandler {
        ...
        public onInitializeAccessibilityEvent(
          param0: androidx.recyclerview.widget.RecyclerView.Recycler,
          param1: androidx.recyclerview.widget.RecyclerView.State,
          param2: android.view.accessibility.AccessibilityEvent
        ): void;
        public computeVerticalScrollOffset(
          param0: androidx.recyclerview.widget.RecyclerView.State
        ): number;
        public computeHorizontalScrollExtent(
          param0: androidx.recyclerview.widget.RecyclerView.State
        ): number;
        ...
        public computeHorizontalScrollRange(
          param0: androidx.recyclerview.widget.RecyclerView.State
        ): number;
        ...
        public computeHorizontalScrollOffset(
          param0: androidx.recyclerview.widget.RecyclerView.State
        ): number;
        public setStackFromEnd(param0: boolean): void;
      ...
      export module LinearLayoutManager {
        export class AnchorInfo {
          public assignFromViewAndKeepVisibleRect(
            param0: android.view.View
          ): void;
        ...
        export class SavedState {
          ...
          public constructor(
            param0: androidx.recyclerview.widget.LinearLayoutManager.SavedState
          );
        }
      }
    }
...
declare module androidx {
  export module recyclerview {
    export module widget {
      export abstract class LinearSmoothScroller extends androidx.recyclerview
        .widget.RecyclerView.SmoothScroller {
        ...
        public calculateDxToMakeVisible(
          param0: android.view.View,
          param1: number
        ): number;
        public onTargetFound(
          param0: android.view.View,
          param1: androidx.recyclerview.widget.RecyclerView.State,
          param2: androidx.recyclerview.widget.RecyclerView.SmoothScroller.Action
        ): void;
        public onStart(): void;
        public onSeekTargetStep(
          param0: number,
          param1: number,
          param2: androidx.recyclerview.widget.RecyclerView.State,
          param3: androidx.recyclerview.widget.RecyclerView.SmoothScroller.Action
        ): void;
        public updateActionForInterimTarget(
          param0: androidx.recyclerview.widget.RecyclerView.SmoothScroller.Action
        ): void;
        public constructor(param0: android.content.Context);
        public constructor();
        public onStop(): void;
        public calculateDyToMakeVisible(
          param0: android.view.View,
          param1: number
        ): number;
  ...
  export module recyclerview {
    export module widget {
      export class OpReorderer {
        public constructor(
          param0: androidx.recyclerview.widget.OpReorderer.Callback
        );
      }
      export module OpReorderer {
        export class Callback {
          /**
           * Constructs a new instance of the androidx.recyclerview.widget.OpReorderer$Callback interface with the provided implementation.
           */
          public constructor(implementation: {
            obtainUpdateOp(
              param0: number,
  ...
  export module recyclerview {
    export module widget {
      export abstract class OrientationHelper {
        ...
        public getDecoratedMeasurementInOther(
          param0: android.view.View
        ): number;
        ...
        public static createVerticalHelper(
          param0: androidx.recyclerview.widget.RecyclerView.LayoutManager
        ): androidx.recyclerview.widget.OrientationHelper;
        public static createHorizontalHelper(
          param0: androidx.recyclerview.widget.RecyclerView.LayoutManager
        ): androidx.recyclerview.widget.OrientationHelper;
        ...
        public static createOrientationHelper(
          param0: androidx.recyclerview.widget.RecyclerView.LayoutManager,
          param1: number
        ): androidx.recyclerview.widget.OrientationHelper;
  ...
  export module recyclerview {
    export module widget {
      export class PositionMap {
        ...
        public clone(): androidx.recyclerview.widget.PositionMap;
        public removeKeyRange(
          param0: javautilArrayList<java.lang.Object>,
          param1: number,
          param2: number
        ): void;
...
/// <reference path="./android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.d.ts" />
/// <reference path="./androidx.recyclerview.widget.RecyclerView.d.ts" />
/// <reference path="./androidx.recyclerview.widget.RecyclerViewAccessibilityDelegate.d.ts" />
/// <reference path="./android.util.AttributeSet.d.ts" />
  ...
  export module recyclerview {
    export module widget {
      export class RecyclerView {
        ...
        public addItemDecoration(
          param0: androidx.recyclerview.widget.RecyclerView.ItemDecoration
        ): void;
        ...
        public setAdapter(
          param0: androidx.recyclerview.widget.RecyclerView.Adapter
        ): void;
        public getAdapter(): androidx.recyclerview.widget.RecyclerView.Adapter;
        public removeOnChildAttachStateChangeListener(
          param0: androidx.recyclerview.widget.RecyclerView.OnChildAttachStateChangeListener
        ): void;
        public onTouchEvent(param0: android.view.MotionEvent): boolean;
        public setRecycledViewPool(
          param0: androidx.recyclerview.widget.RecyclerView.RecycledViewPool
        ): void;
        ...
        public removeDetachedView(
          param0: android.view.View,
          param1: boolean
        ): void;
        public offsetChildrenVertical(param0: number): void;
        public dispatchNestedFling(
          param0: number,
          param1: number,
          param2: boolean
        ): boolean;
        ...
        public removeOnItemTouchListener(
        ...
        public findViewHolderForLayoutPosition(
          param0: number
        ): androidx.recyclerview.widget.RecyclerView.ViewHolder;
        ...
        public addFocusables(
          param0: javautilArrayList<android.view.View>,
          param1: number,
          param2: number
        ): void;
        ...
        public setItemAnimator(
          param0: androidx.recyclerview.widget.RecyclerView.ItemAnimator
        ): void;
        public smoothScrollToPosition(param0: number): void;
        public constructor(param0: android.content.Context);
        public dispatchSaveInstanceState(
          param0: android.util.SparseArray<android.os.Parcelable>
        ): void;
        public isNestedScrollingEnabled(): boolean;
        public focusSearch(
          focused: android.view.View,
          direction: number
        ): android.view.View;
        public checkLayoutParams(
          param0: android.view.ViewGroup.LayoutParams
        ...
        public findContainingViewHolder(
          param0: android.view.View
        ): androidx.recyclerview.widget.RecyclerView.ViewHolder;
        ...
        public dispatchNestedPreScroll(
          param0: number,
          param1: number,
        ...
        public setAccessibilityDelegateCompat(
          param0: androidx.recyclerview.widget.RecyclerViewAccessibilityDelegate
        ): void;
        public findViewHolderForItemId(
          param0: number
        ): androidx.recyclerview.widget.RecyclerView.ViewHolder;
        public swapAdapter(
          param0: androidx.recyclerview.widget.RecyclerView.Adapter,
        ...
        public setChildDrawingOrderCallback(
          param0: androidx.recyclerview.widget.RecyclerView.ChildDrawingOrderCallback
        ): void;
        public addOnChildAttachStateChangeListener(
          param0: androidx.recyclerview.widget.RecyclerView.OnChildAttachStateChangeListener
        ): void;
        ...
        public findContainingItemView(
          param0: android.view.View
        ): android.view.View;
        public setLayoutFrozen(param0: boolean): void;
        public dispatchRestoreInstanceState(
          param0: android.util.SparseArray<android.os.Parcelable>
        ): void;
        public clearOnChildAttachStateChangeListeners(): void;
        public setLayoutManager(
          param0: androidx.recyclerview.widget.RecyclerView.LayoutManager
        ): void;
        public findViewHolderForAdapterPosition(
          param0: number
        ): androidx.recyclerview.widget.RecyclerView.ViewHolder;
        public onSaveInstanceState(): android.os.Parcelable;
        ...
        public setRecyclerListener(
          param0: androidx.recyclerview.widget.RecyclerView.RecyclerListener
        ): void;
        public constructor(
          param0: android.content.Context,
          param1: android.util.AttributeSet
        ...
        public setViewCacheExtension(
          param0: androidx.recyclerview.widget.RecyclerView.ViewCacheExtension
        ): void;
        public addOnItemTouchListener(
          param0: androidx.recyclerview.widget.RecyclerView.OnItemTouchListener
        ): void;
      ...
      export module RecyclerView {
        export abstract class Adapter {
          ...
          public onBindViewHolder(
            param0: androidx.recyclerview.widget.RecyclerView.ViewHolder,
            param1: number,
            param2: javautilList<java.lang.Object>
          ): void;
          ...
          public registerAdapterDataObserver(
            param0: androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
          ): void;
        }
        ...
        export class ChildDrawingOrderCallback {
          /**
           * Constructs a new instance of the androidx.recyclerview.widget.RecyclerView$ChildDrawingOrderCallback interface with the provided implementation.
           */
          public constructor(implementation: {
        ...
        export abstract class ItemAnimator {
          ...
          public animatePersistence(
            param0: androidx.recyclerview.widget.RecyclerView.ViewHolder,
            param1: androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo,
            param2: androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo
          ): boolean;
          public dispatchAnimationStarted(
            param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
          ): void;
          ...
          public recordPostLayoutInformation(
            param0: androidx.recyclerview.widget.RecyclerView.State,
            param1: androidx.recyclerview.widget.RecyclerView.ViewHolder
          ): androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo;
          public recordPreLayoutInformation(
            param0: androidx.recyclerview.widget.RecyclerView.State,
            param1: androidx.recyclerview.widget.RecyclerView.ViewHolder,
            param2: number,
            param3: javautilList<java.lang.Object>
          ): androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo;
          ...
          public dispatchAnimationFinished(
            param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
          ): void;
          public canReuseUpdatedViewHolder(
            param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
        ...
        export module ItemAnimator {
          export class AdapterChanges {
            /**
             * Constructs a new instance of the androidx.recyclerview.widget.RecyclerView$ItemAnimator$AdapterChanges interface with the provided implementation.
             */
            public constructor(implementation: {});
          }
          export class ItemAnimatorFinishedListener {
            /**
             * Constructs a new instance of the androidx.recyclerview.widget.RecyclerView$ItemAnimator$ItemAnimatorFinishedListener interface with the provided implementation.
             */
            public constructor(implementation: {
          ...
          export class ItemAnimatorListener {
            /**
             * Constructs a new instance of the androidx.recyclerview.widget.RecyclerView$ItemAnimator$ItemAnimatorListener interface with the provided implementation.
             */
            public constructor(implementation: {
              onAnimationFinished(
                param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
        ...
        export abstract class ItemDecoration {
          public onDrawOver(
            param0: android.graphics.Canvas,
            param1: androidx.recyclerview.widget.RecyclerView,
            param2: androidx.recyclerview.widget.RecyclerView.State
          ): void;
          public constructor();
          public onDraw(
          ...
          public getItemOffsets(
            param0: android.graphics.Rect,
            param1: android.view.View,
            param2: androidx.recyclerview.widget.RecyclerView,
            param3: androidx.recyclerview.widget.RecyclerView.State
          ): void;
          public onDraw(
            param0: android.graphics.Canvas,
        ...
        export abstract class LayoutManager {
          ...
          public detachAndScrapAttachedViews(
            param0: androidx.recyclerview.widget.RecyclerView.Recycler
          ): void;
          ...
          public removeAndRecycleAllViews(
            param0: androidx.recyclerview.widget.RecyclerView.Recycler
          ): void;
          public static getChildMeasureSpec(
            param0: number,
            param1: number,
            param2: number,
            param3: boolean
          ...
          public onAddFocusables(
            param0: androidx.recyclerview.widget.RecyclerView,
            param1: javautilArrayList<android.view.View>,
            param2: number,
            param3: number
          ): boolean;
          ...
          public calculateItemDecorationsForChild(
            param0: android.view.View,
            param1: android.graphics.Rect
          ): void;
          public supportsPredictiveItemAnimations(): boolean;
          ...
          public requestChildRectangleOnScreen(
            param0: androidx.recyclerview.widget.RecyclerView,
            param1: android.view.View,
            param2: android.graphics.Rect,
            param3: boolean
          ): boolean;
          public startSmoothScroll(
            param0: androidx.recyclerview.widget.RecyclerView.SmoothScroller
          ): void;
          ...
          public onRequestChildFocus(
            param0: androidx.recyclerview.widget.RecyclerView,
            param1: android.view.View,
            param2: android.view.View
          ): boolean;
          public addDisappearingView(
            param0: android.view.View,
            param1: number
          ): void;
          public onInitializeAccessibilityEvent(
          ...
          public onAdapterChanged(
            param0: androidx.recyclerview.widget.RecyclerView.Adapter,
            param1: androidx.recyclerview.widget.RecyclerView.Adapter
          ): void;
          public removeView(param0: android.view.View): void;
          public detachAndScrapView(
            param0: android.view.View,
            param1: androidx.recyclerview.widget.RecyclerView.Recycler
          ): void;
          public onInitializeAccessibilityNodeInfo(
            param0: androidx.recyclerview.widget.RecyclerView.Recycler,
            param1: androidx.recyclerview.widget.RecyclerView.State,
            param2: android.support.v4.view.accessibility.AccessibilityNodeInfoCompat
          ): void;
          ...
          public onRequestChildFocus(
            ...
            param1: androidx.recyclerview.widget.RecyclerView.State,
            param2: android.view.View,
            param3: android.view.View
          ): boolean;
          public attachView(
            param0: android.view.View,
            param1: number,
            param2: androidx.recyclerview.widget.RecyclerView.LayoutParams
          ): void;
          public static getChildMeasureSpec(
            param0: number,
            param1: number,
          ...
          public performAccessibilityActionForItem(
            param0: androidx.recyclerview.widget.RecyclerView.Recycler,
            param1: androidx.recyclerview.widget.RecyclerView.State,
            param2: android.view.View,
            param3: number,
        ...
        export class OnChildAttachStateChangeListener {
          /**
           * Constructs a new instance of the androidx.recyclerview.widget.RecyclerView$OnChildAttachStateChangeListener interface with the provided implementation.
           */
          public constructor(implementation: {
        ...
        export class OnItemTouchListener {
          /**
           * Constructs a new instance of the androidx.recyclerview.widget.RecyclerView$OnItemTouchListener interface with the provided implementation.
           */
          public constructor(implementation: {
        ...
        export class RecyclerListener {
          /**
           * Constructs a new instance of the androidx.recyclerview.widget.RecyclerView$RecyclerListener interface with the provided implementation.
           */
          public constructor(implementation: {
            onViewRecycled(
              param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
        ...
        export class RecyclerViewDataObserver extends androidx.recyclerview
          .widget.RecyclerView.AdapterDataObserver {
          public onItemRangeChanged(
            param0: number,
            param1: number,
            param2: javalangObject
        ...
        export module SmoothScroller {
          export class Action {
            ...
            public update(
              ...
              param1: number,
              param2: number,
              param3: android.view.animation.Interpolator
            ): void;
            public getDx(): number;
            ...
            public setInterpolator(
              param0: android.view.animation.Interpolator
            ): void;
        ...
        export module State {
          export class LayoutState {
            /**
             * Constructs a new instance of the androidx.recyclerview.widget.RecyclerView$State$LayoutState interface with the provided implementation.
             */
            public constructor(implementation: {});
          }
        }
  ...
  export module recyclerview {
    export module widget {
      export class RecyclerViewAccessibilityDelegate {
        ...
        public onInitializeAccessibilityNodeInfo(
          param0: android.view.View,
          param1: android.support.v4.view.accessibility.AccessibilityNodeInfoCompat
        ): void;
        public constructor(param0: androidx.recyclerview.widget.RecyclerView);
        public onInitializeAccessibilityEvent(
          param0: android.view.View,
          param1: android.view.accessibility.AccessibilityEvent
        ): void;
      }
    }
  }
...
declare module androidx {
  export module recyclerview {
    export module widget {
      export abstract class SimpleItemAnimator extends androidx.recyclerview
        .widget.RecyclerView.ItemAnimator {
        public dispatchRemoveFinished(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
        ): void;
        public onMoveFinished(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
        ): void;
        public onChangeStarting(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder,
          param1: boolean
        ): void;
        public dispatchRemoveStarting(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
        ): void;
        public canReuseUpdatedViewHolder(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
        ): boolean;
        public dispatchChangeFinished(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder,
          param1: boolean
        ): void;
        public animateDisappearance(
        ...
        public onMoveStarting(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
        ): void;
        public onRemoveStarting(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
        ): void;
        public constructor();
        public onAddFinished(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
        ): void;
        public animatePersistence(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder,
        ...
        public dispatchMoveFinished(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
        ): void;
        public dispatchMoveStarting(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
        ): void;
        public onChangeFinished(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder,
          param1: boolean
        ): void;
        public animateChange(
        ...
        public dispatchAddFinished(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
        ): void;
        public onAddStarting(
          param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
        ): void;
...
declare module androidx {
  export module recyclerview {
    export module widget {
      export class StaggeredGridLayoutManager extends androidx.recyclerview
        .widget.RecyclerView.LayoutManager {
        ...
        public setMeasuredDimension(param0: number, param1: number): void;
        public findLastCompletelyVisibleItemPositions(
          param0: native.Array<number>
        ): native.Array<number>;
        public computeVerticalScrollOffset(
          param0: androidx.recyclerview.widget.RecyclerView.State
        ...
        public setReverseLayout(param0: boolean): void;
        public scrollToPositionWithOffset(param0: number, param1: number): void;
        public findFirstCompletelyVisibleItemPositions(
          param0: native.Array<number>
        ): native.Array<number>;
        public scrollToPosition(param0: number): void;
        public onItemsAdded(
        ...
        public generateDefaultLayoutParams(): androidx.recyclerview.widget.RecyclerView.LayoutParams;
        public setOrientation(param0: number): void;
        public findFirstVisibleItemPositions(
          param0: native.Array<number>
        ): native.Array<number>;
        public constructor(
          param0: android.content.Context,
        ...
        public findLastVisibleItemPositions(
          param0: native.Array<number>
        ): native.Array<number>;
      }
      export module StaggeredGridLayoutManager {
        ...
        export class LazySpanLookup {
          public addFullSpanItem(
            param0: androidx.recyclerview.widget.StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem
          ): void;
          public getFirstFullSpanItemInRange(
            param0: number,
            param1: number,
            param2: number,
            param3: boolean
          ): androidx.recyclerview.widget.StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem;
          public getFullSpanItem(
            param0: number
          ): androidx.recyclerview.widget.StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem;
        }
        ...
        export class SavedState {
          ...
          public writeToParcel(param0: android.os.Parcel, param1: number): void;
          public constructor(
            param0: androidx.recyclerview.widget.StaggeredGridLayoutManager.SavedState
          );
        }
        export class Span {
          public getFocusableViewAfter(
            param0: number,
            param1: number
          ): android.view.View;
          public findLastCompletelyVisibleItemPosition(): number;
    ...
    export module widget {
      ...
      export module ViewInfoStore {
        ...
        export class ProcessCallback {
          /**
           * Constructs a new instance of the androidx.recyclerview.widget.ViewInfoStore$ProcessCallback interface with the provided implementation.
           */
          public constructor(implementation: {
            processDisappeared(
              param0: androidx.recyclerview.widget.RecyclerView.ViewHolder,
          ...
          public processAppeared(
            param0: androidx.recyclerview.widget.RecyclerView.ViewHolder,
            param1: androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo,
            param2: androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo
          ): void;
          public processPersistent(
            param0: androidx.recyclerview.widget.RecyclerView.ViewHolder,
            param1: androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo,
            param2: androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo
          ): void;
...
/// <reference path="./androidx.recyclerview.widget.RecyclerView.d.ts" />
/// <reference path="./androidx.recyclerview.widget.helper.ItemTouchHelper.d.ts" />
/// <reference path="./androidx.recyclerview.widget.helper.ItemTouchUIUtil.d.ts" />
/// <reference path="./android.view.MotionEvent.d.ts" />
/// <reference path="./android.view.View.d.ts" />
/// <reference path="./java.util.List.d.ts" />
declare module androidx {
    ...
    export module widget {
      export module helper {
        export class ItemTouchHelper
          ...
          public constructor(
            param0: androidx.recyclerview.widget.helper.ItemTouchHelper.Callback
          );
          public startSwipe(
            param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
          ): void;
          public onChildViewAttachedToWindow(param0: android.view.View): void;
          public attachToRecyclerView(
            param0: androidx.recyclerview.widget.RecyclerView
          ): void;
          public onChildViewDetachedFromWindow(param0: android.view.View): void;
        }
        export module ItemTouchHelper {
          export abstract class Callback {
            ...
            public interpolateOutOfBoundsScroll(
              param0: androidx.recyclerview.widget.RecyclerView,
              param1: number,
              param2: number,
              param3: number,
            ...
            public static makeMovementFlags(
              param0: number,
              param1: number
            ): number;
            public getSwipeVelocityThreshold(param0: number): number;
            public getMovementFlags(
              param0: androidx.recyclerview.widget.RecyclerView,
              param1: androidx.recyclerview.widget.RecyclerView.ViewHolder
            ): number;
            public onChildDraw(
              param0: android.graphics.Canvas,
              param1: androidx.recyclerview.widget.RecyclerView,
              param2: androidx.recyclerview.widget.RecyclerView.ViewHolder,
              param3: number,
              param4: number,
              param5: number,
              param6: boolean
            ): void;
            public chooseDropTarget(
              param0: androidx.recyclerview.widget.RecyclerView.ViewHolder,
              param1: javautilList<
                androidx.recyclerview.widget.RecyclerView.ViewHolder
              >,
            ...
            public static getDefaultUIUtil(): androidx.recyclerview.widget.helper.ItemTouchUIUtil;
            ...
            public convertToAbsoluteDirection(
              param0: number,
              param1: number
            ): number;
            public onMoved(
              ...
              param1: androidx.recyclerview.widget.RecyclerView.ViewHolder,
              param2: number,
              param3: androidx.recyclerview.widget.RecyclerView.ViewHolder,
              param4: number,
              param5: number,
              param6: number
            ): void;
            public onChildDrawOver(
              param0: android.graphics.Canvas,
              param1: androidx.recyclerview.widget.RecyclerView,
              param2: androidx.recyclerview.widget.RecyclerView.ViewHolder,
              param3: number,
            ...
            public getSwipeThreshold(
              param0: androidx.recyclerview.widget.RecyclerView.ViewHolder
            ): number;
            public static convertToRelativeDirection(
              param0: number,
              param1: number
            ): number;
          ...
          export class RecoverAnimation {
            ...
            public onAnimationCancel(
              param0: android.support.v4.animation.ValueAnimatorCompat
            ): void;
            ...
            public start(): void;
            public constructor(
              param0: androidx.recyclerview.widget.helper.ItemTouchHelper,
              param1: androidx.recyclerview.widget.RecyclerView.ViewHolder,
              param2: number,
              param3: number,
              param4: number,
          ...
          export abstract class SimpleCallback extends androidx.recyclerview
            .widget.helper.ItemTouchHelper.Callback {
            public constructor();
            public constructor(param0: number, param1: number);
            public getSwipeDirs(
              param0: androidx.recyclerview.widget.RecyclerView,
          ...
          export class ViewDropHandler {
            /**
             * Constructs a new instance of the androidx.recyclerview.widget.helper.ItemTouchHelper$ViewDropHandler interface with the provided implementation.
             */
            public constructor(implementation: {
              prepareForDrop(
                param0: android.view.View,
    ...
    export module widget {
      export module helper {
        export class ItemTouchUIUtil {
          /**
           * Constructs a new instance of the androidx.recyclerview.widget.helper.ItemTouchUIUtil interface with the provided implementation.
           */
          public constructor(implementation: {
            onDraw(
              param0: android.graphics.Canvas,
    ...
    export module widget {
      export module helper {
        ...
        export module ItemTouchUIUtilImpl {
          ...
          export class Lollipop extends androidx.recyclerview.widget.helper
...
declare module androidx {
  export module recyclerview {
    export module widget {
      export module util {
        export abstract class SortedListAdapterCallback extends androidx
          .recyclerview.util.SortedList.Callback {
          public constructor();
          public constructor(
            param0: androidx.recyclerview.widget.RecyclerView.Adapter
          );
